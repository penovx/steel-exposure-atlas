...
PUBLIC_URL = "https://penovx.github.io/steel-exposure-atlas/"
...
class ReleaseSurfaceContractTests(unittest.TestCase):
    def test_homepage_has_public_share_metadata(self) -> None:
        ...
        self.assertIn('<meta name="robots" content="index,follow">', index)
        ...
        self.assertIn(f'<meta property="og:url" content="{PUBLIC_URL}">', index)
        ...
        # v0.1 intentionally ships without a dedicated social-preview image.
        # Do not invent or hotlink an asset solely to fill the card.
    ...
    def test_public_privacy_notice_is_linked_and_minimal(self) -> None:
        ...
        self.assertIn(
            "does not set tracking cookies or use browser storage for visitor profiling",
            privacy,
        )
        ...
        self.assertIn('<meta name="robots" content="noindex,follow">', privacy)
        self.assertIn(
            '<link rel="canonical" href="https://penovx.github.io/steel-exposure-atlas/privacy.html">',
            privacy,
        )
